### NOTE: EXTRA TEMPLATE DOC FOUND IN OTHER FOLDER.
### FOR QUICK START ON HOW TO RUN THIS TEMPLATE IN DEVELOPMENT. SEE DOC FOLDER
### THERE IS ALREADY BUILD FOLDER WHICH INCLUDE PRODUCTION VERSION. JUST USE ANY HTML5 PUSHSTATE ENABLED SERVER FOR DEMO.


### OFFICIAL CREATE-REACT-APP CLI DOC
-------------------------------------
